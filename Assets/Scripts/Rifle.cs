...
/*
 * This script is used for the automatic rifle.
 * It is similar to the pistol script, but allows for fully automatic fire with the player holding down the mouse button to keep firing.
*/ 
...
public class Rifle : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0) && currentFireRate <= 0 && currentAmmoCount > 0 && !isReloading)
        {
            //Resets Firerate
    ...
    private void Shoot()
    {
        ...
        muzzleFlash.Play();
        soundManager.PlaySound("RifleShot");
